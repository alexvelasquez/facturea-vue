                            ...
                            <v-container>
                                <v-row>
                                    <v-col cols="12" sm="12" md="6">
                                        <v-text-field v-model="cliente.razon_social" label="Razón social" placeholder="Razon social" hint="campo obligatorio(*)" :rules="obligatorio" outlined dense persistent-hint persistent-hint>
                                        </v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="12" md="6">
                                    ...
                                    <v-col cols="12" sm="6" md="4">
                                        <v-text-field v-model="cliente.documento" label="Documento" placeholder="0" type="number" outlined dense persistent-hint :disabled="disabled">
                                        </v-text-field>
                                    </v-col>

                                    <v-col cols="12" sm="6" md="6">
                                        <v-autocomplete v-model="cliente.localidad.provincia.provincia_id" item-value="provincia_id" autocomplete="new-password" :items="provincias" :label="'Provincia'" placeholder="seleccione una provincia" item-text="descripcion" persistent-hint hint="campo obligatorio(*)" :rules="obligatorio"
                                        outlined dense persistent-hint>
                                        </v-autocomplete>
                                    </v-col>

                                    <v-col cols="12" sm="6" md="6">
                                        <v-autocomplete v-model="cliente.localidad.localidad_id" item-value="localidad_id" autocomplete="new-password" :items="localidades" :label="'Localidad'" placeholder="seleccione una localidad" item-text="descripcion" persistent-hint hint="campo obligatorio(*)" :rules="obligatorio"
                                        outlined dense persistent-hint>
                                        </v-autocomplete>
                                    </v-col>
                                    <v-col cols="12" sm="6" md="6">
