                    ...
                    <v-form ref="form">
                        <v-card-text>
                            <v-container>
                                ...
                                <v-row>
                                    <v-col cols="12"  md="3">
                                        <v-text-field  v-model="nuevoProducto.cantidad" label="Cantidad" outlined min="0.1" type="number" dense></v-text-field>
                                    </v-col>

                                    <v-col cols="12" md="9">
                                      <v-autocomplete v-model="nuevoProducto.producto" :items="productos" return-object item-text="descripcion" label="Descripción" placeholder="Buscar por descripción o código" outlined persistent-hint dense color="#385F73">
                                      </v-autocomplete>
                                    </v-col>
                                    <v-col cols="12"  md="3" >
                                    ...
                                    <v-col cols="12" md="3" v-if="esResponsableInscripto">
                                      <v-autocomplete  v-model="nuevoProducto.tipo_alicuota" :items="tiposAliCuotas" return-object item-text="descripcion" label="IVA(%)" placeholder="Seleccionar" outlined persistent-hint dense color="#385F73">
                                      </v-autocomplete>
                                    </v-col>
                                    <v-col cols="12" md="3">
