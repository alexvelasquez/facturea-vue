...
<div class="home">
    ...
    <div>
        <v-row>
            <v-col cols="12">
                <v-row no-gutters>
                    <v-col cols="12">
                        <p class="text font-weight-bold blue-grey--text text--lighten-2">Informes: {{periodo.fechaDesde| formatDate}} - {{periodo.fechaHasta | formatDate}}</p>
                    </v-col>
                </v-row>
    ...
    <div >
        ...
        <line-chart v-if="dataGraficos.datasets" :labels="dataGraficos.labels" :datasets="dataGraficos.datasets"></line-chart>
    </div>
